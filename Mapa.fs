...
let spawnmapcollection:list<Room> =[ //unico, sala de destino siempre
    ...
    }
    {
        ...
        Mapa=array2D [
            [|'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w'|]
            [|'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w'|]
            [|'w';'w';'s';'f';'f';'f';'f';'f';'f';'f';'f';'f';'s';'w';'w'|]
            [|'w';'w';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'w';'w'|]
            [|'w';'w';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'w';'w'|]
            [|'w';'w';'f';'f';'f';'f';'f';'f';'f';'f';'w';'f';'f';'w';'w'|]
            [|'w';'f';'f';'f';'f';'f';'f';'f';'f';'f';'w';'f';'f';'f';'w'|]
            [|'w';'f';'f';'f';'f';'f';'f';'f';'f';'f';'w';'f';'f';'f';'d'|]
            [|'w';'f';'f';'f';'f';'f';'f';'f';'f';'f';'w';'f';'f';'f';'w'|]
            [|'w';'w';'f';'f';'f';'f';'f';'f';'f';'f';'w';'f';'f';'w';'w'|]
            [|'w';'w';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'w';'w'|]
            [|'w';'w';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'w';'w'|]
    ...
    }
    {
        ...
        Mapa=array2D [
            ...
            [|'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a'|]
            [|'a';'a';'a';'a';'f';'f';'f';'f';'f';'f';'f';'f';'f';'a';'a'|]
            [|'a';'a';'a';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'a';'a'|]
            [|'a';'a';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'a';'a'|]
            [|'a';'a';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'a';'a'|]
            [|'a';'f';'f';'f';'f';'f';'f';'s';'f';'f';'f';'f';'f';'f';'w'|]
            [|'a';'f';'f';'f';'f';'f';'s';'s';'s';'f';'f';'f';'f';'f';'d'|]
            [|'a';'f';'f';'f';'f';'f';'f';'s';'f';'f';'f';'f';'f';'f';'w'|]
            [|'a';'a';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'a';'a'|]
            [|'a';'a';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'f';'a';'a'|]
    ...
    }
    {
        ...
        Mapa=array2D [
            [|'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w'|]
            [|'w';'s';'f';'f';'f';'s';'w';'s';'f';'f';'f';'f';'f';'s';'w'|]
            [|'w';'f';'f';'f';'f';'f';'w';'f';'f';'f';'f';'f';'f';'f';'w'|]
            [|'w';'f';'f';'f';'f';'f';'w';'f';'f';'f';'w';'f';'f';'f';'w'|]
            [|'w';'f';'f';'f';'f';'f';'w';'f';'f';'f';'w';'f';'f';'f';'w'|]
            [|'w';'f';'f';'w';'f';'f';'w';'f';'f';'f';'w';'f';'f';'f';'w'|]
            [|'w';'f';'f';'w';'f';'f';'f';'f';'f';'f';'w';'f';'f';'f';'w'|]
            [|'w';'f';'f';'w';'f';'f';'f';'f';'f';'f';'w';'f';'f';'f';'d'|]
            [|'w';'f';'f';'w';'f';'f';'f';'f';'f';'f';'w';'f';'f';'f';'w'|]
            [|'w';'f';'f';'w';'f';'f';'w';'f';'f';'f';'w';'f';'f';'f';'w'|]
            [|'w';'f';'f';'f';'f';'f';'w';'f';'f';'f';'w';'f';'f';'f';'w'|]
            [|'w';'f';'f';'f';'f';'f';'w';'f';'f';'f';'w';'f';'f';'f';'w'|]
            [|'w';'f';'f';'f';'f';'f';'w';'f';'f';'f';'w';'f';'f';'f';'w'|]
            [|'w';'s';'f';'f';'f';'s';'w';'s';'f';'s';'w';'s';'f';'s';'w'|]
            [|'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w'|]
        ]
        Puertas=[{Posicion=(7,14); Sala_destino=2}]
        Items=[]
    }
    {
        ...
        Mapa=array2D [
            ...
            [|'w';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'w'|]
            [|'w';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'w'|]
            [|'w';'a';'a';'a';'a';'a';'a';'a';'a';'f';'f';'f';'a';'a';'w'|]
            [|'w';'a';'a';'a';'a';'a';'a';'a';'f';'f';'f';'f';'f';'a';'w'|]
            [|'w';'f';'f';'a';'a';'a';'a';'f';'f';'f';'f';'f';'f';'f';'w'|]
            [|'w';'f';'f';'f';'a';'a';'f';'f';'f';'f';'a';'a';'f';'f';'d'|]
            [|'w';'f';'f';'f';'f';'f';'f';'f';'f';'a';'a';'a';'f';'f';'w'|]
            [|'w';'a';'f';'f';'f';'f';'f';'f';'a';'a';'a';'a';'a';'a';'w'|]
            [|'w';'a';'a';'f';'f';'f';'f';'a';'a';'a';'a';'a';'a';'a';'w'|]
            [|'w';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'w'|]
            [|'w';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'w'|]
            [|'w';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'a';'w'|]
            [|'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w';'w'|]
