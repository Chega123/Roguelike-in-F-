...
def load_images():
    ...
    image_map = {
        ...
        'W': pygame.image.load(f'sprites/jugador/player{numero_aleatorio}up.jpg'),
        'S': pygame.image.load(f'sprites/jugador/player{numero_aleatorio}down.jpg'),
        'A': pygame.image.load(f'sprites/jugador/player{numero_aleatorio}left.jpg'),
        'D': pygame.image.load(f'sprites/jugador/player{numero_aleatorio}right.jpg'),
        ...
        '5': pygame.image.load(f'sprites/Armas/espada{numero_aleatorio}.jpg'),
        '6': pygame.image.load(f'sprites/Armas/lanza{numero_aleatorio}.jpg'),
        '7': pygame.image.load(f'sprites/Armas/arco{numero_aleatorio}.jpg'),
        '8': pygame.image.load(f'sprites/Armas/mandoble{numero_aleatorio}.jpg'),
        '9': pygame.image.load(f'sprites/Armas/daga{numero_aleatorio}.jpg'),
        '*': pygame.image.load(f'sprites/Armas/Chayanne{numero_aleatorio}.jpg'),
        '&': pygame.image.load(f'sprites/enemigo/dragonrojo{numero_aleatorio}.jpg'),
        '%': pygame.image.load(f'sprites/enemigo/golempiedra{numero_aleatorio}.jpg'),
        '$': pygame.image.load(f'sprites/enemigo/senorcaos{numero_aleatorio}.jpg'),
